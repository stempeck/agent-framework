...
public class ExecutorRouteGeneratorTests
{
    ...
    [Fact]
    public void Baseline_SingleVoidHandler_FullGeneratedOutput()
    {
        var source = """
            using System.Threading;
            using System.Threading.Tasks;
        ...
        var generatedText = result.RunResult.GeneratedTrees[0].GetText().ToString();

        generatedText.Should().Contain("// <auto-generated/>");
        generatedText.Should().Contain("#nullable enable");
        generatedText.Should().Contain("namespace TestNamespace;");
        generatedText.Should().Contain("partial class TestExecutor");
        generatedText.Should().Contain("protected override ProtocolBuilder ConfigureProtocol(ProtocolBuilder protocolBuilder)");
        generatedText.Should().Contain("return protocolBuilder");
        generatedText.Should().Contain(".ConfigureRoutes(ConfigureRoutes);");
        generatedText.Should().Contain("void ConfigureRoutes(RouteBuilder routeBuilder)");
        generatedText.Should().Contain(".AddHandler<global::System.String>(this.HandleMessage)");
        generatedText.Should().NotContain("base.ConfigureProtocol");
    }

    [Fact]
    public void Baseline_MultiHandlerMixedSignatures_FullGeneratedOutput()
    {
        var source = """
            using System.Threading;
            using System.Threading.Tasks;
            ...
            public partial class TestExecutor : Executor
            {
                ...
                [MessageHandler]
                private ValueTask<int> HandleDoubleAsync(double message, IWorkflowContext context)
                {
                    return new ValueTask<int>(42);
                }
            }
        ...
        generatedText.Should().Contain(".ConfigureRoutes(ConfigureRoutes);");
        generatedText.Should().Contain("void ConfigureRoutes(RouteBuilder routeBuilder)");
        generatedText.Should().Contain(".AddHandler<global::System.String>(this.HandleString)");
        generatedText.Should().Contain(".AddHandler<global::System.Double, global::System.Int32>(this.HandleDoubleAsync)");
    }

    [Fact]
    public void Baseline_FullProtocol_HandlersAndClassAttributes_FullGeneratedOutput()
    {
        var source = """
            using System;
            using System.Threading;
            ...
            [SendsMessage(typeof(Foo))]
            [YieldsOutput(typeof(Bar))]
            public partial class TestExecutor : Executor
            {
                public TestExecutor() : base("test") { }
        ...
        generatedText.Should().Contain("protected override ProtocolBuilder ConfigureProtocol(ProtocolBuilder protocolBuilder)");
        generatedText.Should().Contain("return protocolBuilder");
        generatedText.Should().Contain(".SendsMessage<global::TestNamespace.Foo>()");
        generatedText.Should().Contain(".YieldsOutput<global::TestNamespace.Bar>()");
        generatedText.Should().Contain(".ConfigureRoutes(ConfigureRoutes);");
        generatedText.Should().Contain("void ConfigureRoutes(RouteBuilder routeBuilder)");
        generatedText.Should().Contain(".AddHandler<global::System.String>(this.HandleMessage)");
    }
    ...
    #region New Diagnostic Tests (MAFGENWF008-010, upgraded MAFGENWF006)

    [Fact]
    public void DuplicateInputType_ProducesDiagnostic()
    {
        var source = """
            using System.Threading;
            using System.Threading.Tasks;
            ...
            public partial class TestExecutor : Executor
            {
                ...
                [MessageHandler]
                private void HandleString1(string message, IWorkflowContext context) { }

                [MessageHandler]
                private void HandleString2(string message, IWorkflowContext context) { }
            }
            """;

        GeneratorTestHelper.AssertProducesDiagnostic(source, "MAFGENWF008");
    }

    [Fact]
    public void TooManyParameters_ProducesDiagnostic()
    {
        var source = """
            using System.Threading;
            using System.Threading.Tasks;
            ...
            public partial class TestExecutor : Executor
            {
                ...
                [MessageHandler]
                private void HandleMessage(string message, IWorkflowContext context, CancellationToken ct, int extra) { }
            }
            """;

        GeneratorTestHelper.AssertProducesDiagnostic(source, "MAFGENWF009");
    }

    [Fact]
    public void NonCancellationTokenThirdParam_ProducesDiagnostic()
    {
        var source = """
            using System.Threading;
            using System.Threading.Tasks;
            ...
            public partial class TestExecutor : Executor
            {
                ...
                [MessageHandler]
                private void HandleMessage(string message, IWorkflowContext context, int notACancellationToken) { }
            }
            """;

        GeneratorTestHelper.AssertProducesDiagnostic(source, "MAFGENWF010");
    }

    [Fact]
    public void ConfigureProtocolWarning_OnGenericExecutorBase_ProducesWarning()
    {
        var source = """
            using System.Threading;
            using System.Threading.Tasks;
            ...
            public partial class TestExecutor : Executor<string>
            {
                public TestExecutor() : base("test") { }
        ...
        var diag = result.RunResult.Diagnostics.Should().Contain(d => d.Id == "MAFGENWF006").Subject;
        diag.First().Severity.Should().Be(CodeAnalysis.DiagnosticSeverity.Warning);
    }

    [Fact]
    public void ConfigureProtocolInfo_OnPlainExecutorBase_ProducesInfo()
    {
        var source = """
            using System.Threading;
            using System.Threading.Tasks;
        ...
        var diag = result.RunResult.Diagnostics.Should().Contain(d => d.Id == "MAFGENWF006").Subject;
        diag.First().Severity.Should().Be(CodeAnalysis.DiagnosticSeverity.Info);
    }
